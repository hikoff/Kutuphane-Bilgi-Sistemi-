        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            catch (SqlException ex)
            {
                if (ex.ErrorCode == -2146232060) 
                {
                    ...
                    MessageBox.Show("Veri Tabanında bulunan bir veriyi tekrar girmeye çalıştınız, lütfen girdiğiniz veriyi kontrol edin.");
                }
                else
                {
                    
                    MessageBox.Show("Bilinmeyen bir SqlException hatası oluştu.");
                }
